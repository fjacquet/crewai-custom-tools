...
class SerperSearchTool(BaseTool):
    ...
    @api_tool(provider="Serper", endpoint="Search", default_return="Error performing search: API call failed.")
    def _run(self, query: str) -> str:
        ...
        if not isinstance(query, str):
            ...
            query = str(d.get('query') or d.get('search_query') or d.get('description') or query)
