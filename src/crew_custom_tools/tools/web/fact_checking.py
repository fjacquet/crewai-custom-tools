...
logger = logging.getLogger("crew_custom_tools.fact_checking")
...
class GoogleFactCheckTool(BaseTool):
    ...
    description: str = "Searches Google's Database for fact-checked claims on a given query."
    args_schema: type[BaseModel] = GoogleFactCheckInput

    @api_tool(provider="GoogleFactCheck", endpoint="Search", default_return="Error performing fact check.")
